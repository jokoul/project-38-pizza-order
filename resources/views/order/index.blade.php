                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form action="{{ route('order.status',$order->id) }}" method="post">
                                    @csrf
                                    <td>
                                        <input name="status" type="submit" class="btn btn-primary btn-sm" value="Accepted">
                                    </td>
                                    <td>
                                        <input name="status" type="submit" class="btn btn-danger btn-sm" value="rejected">
                                    </td>
                                    <td>
                                        <input name="status" type="submit" class="btn btn-success btn-sm" value="completed">
                                    </td>
                                </form>
                            </tr>
                            @endforeach
